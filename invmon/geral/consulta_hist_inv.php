...
<!--
	...
	function valida(){
		var ok = validaForm('idComp_inv','INTEIRO','Etiqueta',1);
		return ok;
	}
...
<?
	print "<br><B>Consulta histórico por Etiqueta:</B><BR><br>";
	...
	print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>Unidade:</font></font></TD>";
	...
	print "<TR>";
		print "<TD width='20%' align='left' bgcolor='".TD_COLOR."'>Etiqueta:</font></font></TD>";
		print "<TD width='30%' align='left' bgcolor='".BODY_COLOR."'>".
	...
	print "<TR>";
		...
		print "<TD align='center' bgcolor='".BODY_COLOR."'><input type='submit' class='button' value='Consultar' name='ok'>";
		print "</TD>";
		print "<TD align='center' bgcolor='".BODY_COLOR."'>".
			"<INPUT type='reset' class='button' value='Cancelar' onClick='javascript:history.back()'></TD>";
	print "</TR>";
	print "</table>";
	print "</form>";

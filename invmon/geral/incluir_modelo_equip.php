...
<TABLE border="1"  align="center" width="100%" bgcolor=<?php print BODY_COLOR?>>
        ...
        <TABLE border="1"  align="center" width="100%" bgcolor=<?php print TD_COLOR?>>
                <TD width="20%" align="left" bgcolor=<?php print TD_COLOR?>>Tipo:</TD>
                <TD width="80%" align="left" bgcolor=<?php print BODY_COLOR?>><INPUT type="text" name="tipo_nome" maxlength="30" size="100"></TD>
        </TABLE>
        </TR>

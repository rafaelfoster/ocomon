...
<TABLE border="1"  align="center" width="100%" bgcolor=<?php print BODY_COLOR?>>
        ...
        <TABLE border="1"  align="center" width="100%" bgcolor=<?php print TD_COLOR?>>
                <TD width="20%" align="left" bgcolor=<?php print TD_COLOR?>>Resolução:</TD>
                <TD width="80%" align="left" bgcolor=<?php print BODY_COLOR?>><INPUT type="text" name="resol_nome" value="<?php print mysql_result($resultado,0,1);?>" maxlength="100" size="100"></TD>
        </TABLE>
        </TR>
        <TR>
        ...
        <TABLE  border="0" cellpadding="0" cellspacing="0" align="center" width="100%" bgcolor=<?php print TD_COLOR?>>
        <TR>
                <TD align="center" width="100%" bgcolor=<?php print BODY_COLOR?>><a href=resolucao.php>Voltar</a></TD>
        </TR>
        </TABLE>

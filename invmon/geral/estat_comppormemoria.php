	...
	$linhasInst = mysql_num_rows($resultadoInst);
		...
		while ($row = mysql_fetch_array($resultado)) {
			...
			print "<TR>";
				...
				print "<TD bgcolor='".$color."'><a href='mostra_consulta_comp.php?comp_tipo_equip=".$row['tipo']."&comp_memo=".$row['tipo_memo']."&ordena=local,etiqueta' title='Exibe a listagem dos equipamentos cadastrados com essa quantidade de memória.'>".$row['memoria']." MB</a></TD>";
				print "<TD bgcolor='".$color."'>".$row['qtd']."</TD>";
				print "<TD bgcolor='".$color."'>".$row['porcento']."</TD>";
				print "</TR>";
				$i++;
		}
		print "<TR><TD bgcolor='".$cor3."'><b></TD><TD bgcolor='".$cor3."'><b></TD><TD bgcolor='".$cor3."'><b>Total: <font color='red'>".$total."</font></TD><TD bgcolor='".$cor3."'><b>".$percentualGeral."%</b></TD></tr>";
		print "</TABLE>";
		print "</fieldset>";
		...
		print "<tr><td class='line'></TD></tr>";
		print "<tr><td class='line'></TD></tr>";
		print "<tr><td width='80%' align='cente'r><b>Sistema em desenvolvimento pelo setor de Helpdesk  do <a href='http://www.unilasalle.edu.br' target='_blank'>Unilasalle</a>.</b></td></tr>";
		print "</TABLE>";

...
class dateOpers {
	...
	function tempo_valido($data1,$data2,$hora_ini,$hora_fim,$meio_dia,$sabado,$saida){
		...
		if (empty($data1)|| empty($data2)) {
			...
			//dump($data1_aux,'DATA 1 AUX');
			//dump($data2_aux,'DATA 2 AUX');
			//dump($data1,'DATA 1');
			//dump($data2,'DATA 2');

			//Verifica se existem feriados nos dias √∫teis cadastrados na tabela feriados entre as duas datas;
			$sql = "SELECT data_feriado AS dia_semana ".
				"FROM feriados ".
				"WHERE data_feriado BETWEEN '".$data1."' AND '".$data2."' ".
					"AND date_format( data_feriado, '%w' ) NOT IN ( 0, 6 )";

			$resultado = mysql_query($sql);
			$feriados = mysql_num_rows($resultado);//Em dias √∫teis

			print "Feriados: ".$feriados."<br>";
			...
			print "Feriados em Domingo: ".$feriados_domingo."<br>";
			...
			print "DiferenÁa em segundos: ".$diffSegundos."<br>";
			print "<b>Dias cheios:</b> ".$dias_cheios."<br>";
			print "Total de Horas: ".$this->diff["tHoras"]."<br>";
			...
			print "<b>Total de Horas cheias: ".$t_horas."</b><br>";

			print "<br>";
			print "Var: $"."dia_abert: ".$dia_abert."<br>";
			print "Var: $"."dia_fech: ".$dia_fech."<br>";

			$hora_1 = $data1_aux[3];
			$hora_2 = $data2_aux[3];

			print "Var: $"."hora_1: ".$hora_1."<br>";
			print "Var: $"."hora_2: ".$hora_2."<br>";
			...
			print "<b>Horas invalidas: ".$invalidos."</b><br>";

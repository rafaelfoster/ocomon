...
class auth {
	...
	function testa_user($s_usuario, $s_nivel, $s_nivel_desc, $permissao){
		...
		if ($s_nivel>$permissao) //se o nível do usuário for maior do que a permissão necessária para o script..
		{
			...
			$this->saida =  "<TABLE bgcolor='#999999' cellspacing='1' border='1' cellpadding='1' align='center' width='100%'>".//#5E515B
		        		"<tr>".
						"<TD bgcolor='".TD_COLOR."'>". //#999999  //".TD_COLOR."
		                "<TABLE cellspacing='0' border='0' cellpadding='0' bgcolor='".TD_COLOR."'>". //".TD_COLOR."
		                        "<TR>".
								"<TD nowrap width='80%'><b>".$this->texto."".
								"</b></td><td width='20%' nowrap>".

...
*/session_start();
	...
	if (!isset($_POST['ok'])) { //&& $_POST['ok'] != 'Pesquisar')
		...
		if ((!isset($_POST['d_ini'])) || ((!isset($_POST['d_fim'])))) {
			...
			print "<tr><td ><b>".TRANS('FIELD_REPLY_IN_EVEN')." ".$slaR2M." ".TRANS('FIELD_MINUTES').":</b></TD><td ><font color=".$corSla1."> ".$slaR_green." ".TRANS('FIELD_CALL')." = </font></TD><td ><font color=".$corSla1.">".$perc_ate_slaR2."%</font></td><td ></td></tr>";
			print "<tr><td ><b>".TRANS('FIELD_REPLY_IN_EVEN')." ".$slaR3M." ".TRANS('FIELD_MINUTES').":</b></TD><td ><font color=".$corSla2."> ".$slaR_yellow." ".TRANS('FIELD_CALL')."s = </font></TD><td ><font color=".$corSla2.">".$perc_ate_slaR3."%</font></td><td ></td></tr>";
			print "<tr><td ><b>".TRANS('FIELD_REPLY_MORE_THAN')." ".$slaR3M." ".TRANS('FIELD_MINUTES').":</b></TD><td ><font color=".$corSla3."> ".$slaR_red." ".TRANS('FIELD_CALL')." = </font></TD><td ><font color=".$corSla3.">".$perc_mais_slaR3."%</font></td><td ></td></tr>";

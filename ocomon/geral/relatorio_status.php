...
<BR>
<B>Relatório de ocorrências por status</B>
<BR>
...
<TABLE border="1"  align="center" width="100%" bgcolor=<?php print BODY_COLOR?>>
        ...
        <TABLE border="1"  align="center" width="100%" bgcolor=<?php print TD_COLOR?>>
                <TD width="10%" align="left" bgcolor=<?php print TD_COLOR?>>Status:</TD>
                ...
                <TD width="15%" align="left" bgcolor=<?php print TD_COLOR?>>Período de:</TD>

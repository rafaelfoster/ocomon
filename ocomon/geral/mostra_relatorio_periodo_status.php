...
<TABLE border="0"  align="center" width="100%">
        ...
        while ($i < $linhas_status)
        {
                ...
                <TR>
                <TABLE border="0"  align="center" width="100%">
                        <TD width="20%" align="left"><?php print mysql_result($resultado_status,$i,1);?>:</TD> //Foi alterado a posição de inicio 
	//no vetor
                        <TD width="30%" align="left"><?php print $linhas_stat;?></TD>
                        <TD width="20%" align="left">Percentual:</TD>
                        <TD width="30%" align="left"><?php print round(($linhas_stat*100)/$linhas_total);?>%</TD>
                </TABLE>
                </TR>
                <?php 
                $i++;

...
<?php 
        ...
        print "<BR><B>OcoMon - Relatório de ocorrências por local.</B> - <a href=relatorio_local.php>Voltar</a><BR>";
        print "<HR>";
?>
<TABLE border="0"  align="center" width="100%">
        ...
        <TR>
        <TABLE border="0"  align="center" width="100%">
                <TD width="34%" align="left"><?php print mysql_result($resultado_loc,0,0);?></TD>

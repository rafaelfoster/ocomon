...
<BR>
<B>Relatório de ocorrências por Área responsável:</B>
<BR>
...
<TABLE border="1"  align="center" width="100%" bgcolor=<?php print BODY_COLOR?>>
		<?php 
                if ($msg=="dtinvalida") {
					echo "<TR><TD width=\"20%\" align=\"center\" bgcolor=".TD_COLOR."><B>Data Inválida!</B></TD></TR>";
                }
		?>
        <TR>
        <TABLE border="1"  align="center" width="100%" bgcolor=<?php print TD_COLOR?>>
                ...
                <TD width="30%" align="left" bgcolor=<?php print BODY_COLOR?>><?php print "<INPUT type=text name=data_inicial value=\"$di\" size=15 maxlength=15>";?></TD>
                <TD width="20%" align="left" bgcolor=<?php print TD_COLOR?>>Data abertura (final):</TD>
                <TD width="30%" align="left" bgcolor=<?php print BODY_COLOR?>><?php print "<INPUT type=text name=data_final value=\"$df\" size=15 maxlength=15>";?></TD>
        </TABLE>
        </TR>
